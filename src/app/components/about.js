...
const timeline = [
  {
    year: '2015',
    event: '海南欧波曼健康管理有限公司创立于重庆，专注高端定制美容服务。',
  },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f7f7f7] via-[#fff] to-[#e5eaf3] pb-20 relative overflow-x-hidden">
        ...
        <div className="flex flex-col gap-10">
          ...
          >
            ...
            <div className="text-lg md:text-xl text-[#444] leading-relaxed">
              海南欧波曼健康管理有限公司，源自对美与健康的极致追求。我们坚信，真正的美丽源于内心的自信与身心的平衡。悦颜以欧式高端空间为载体，融合自然疗愈与现代科技，致力于为每一位女性提供科学、安全、有效的个性化美容方案。
            </div>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
      ...
      <footer className="py-12 text-center text-[#b7b7b7] text-lg bg-white/60 border-t border-[#ececec] mt-10">
        ...
        <div className="mb-2">
          地址：海南省三亚市天涯区河西路佳和巷17号三楼307房
        </div>
        <div className="mt-2">
          © 2025 海南欧波曼健康管理有限公司. All Rights Reserved.
        </div>
      </footer>
    </div>
  )
